...
\begin{figure}[!htbp]
  ...
  \caption{Orthographic display of the first volume from the
    ...
    the mid-axial, mid-sagittal and mid-coronal planes are chosen.}
...
As seen in Figure~\ref{fig:ffd-orthographic} the mid-axial,
...
The authors would like to thank...
 VS is supported by the LMU innovative project BioMed-S: 
